        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-gray-600 mb-12 leading-relaxed text-lg">
              SDコンサル株式会社は、一級建築士事務所として、関西を拠点に全国にて建築設計業務とコンサルティング業務を展開しています。私たちは、豊かな経験と確かな技術で、多様なニーズに応えるソリューションを提供します。
            </p>
              ...
              <table className="w-full min-w-[768px]">
                ...
                <tbody>
                  {[
                    ...
                    ['系統用蓄電池プロジェクトの建設地の戦略的評価および選定（BESS Project Origination）', '西日本全域'],
                  ].map((item, index) => (
                    <tr key={index} className="border-b hover:bg-gray-50">
                      <td className="py-4 px-6">{item[0]}</td>
                      <td className="py-4 px-6">{item[1]}</td>
